...
type OrderDeliveredResponse = Either<ResourceNotFoundError|NotAllowedError|NeedAttachmentError, null>


export class OrderDeliveredUseCase {
  constructor(private orderRepository: OrderRepository) {}

  async execute({orderId, deliveryManId, attachmentIds}: OrderDeliveredRequest): Promise<OrderDeliveredResponse>{  
