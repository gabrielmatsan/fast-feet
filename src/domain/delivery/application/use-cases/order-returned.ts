...
type OrderReturnedResponse = Either<ResourceNotFoundError|NotAllowedError, null>


export class OrderReturnedUseCase {
  constructor(private orderRepository: OrderRepository) {}

  async execute({orderId, deliveryManId}: OrderReturnedRequest): Promise<OrderReturnedResponse>{  
